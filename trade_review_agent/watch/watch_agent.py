...
from trade_review_agent.watch.alerts import AlertEvent, AlertPlan
from trade_review_agent.watch.alert_tts import synthesize_edge_tts
...
def build_watch_plan(
    *,
    ...
    provider = MarketDataProvider(cache_db=cache_db, adjust="qfq", disable_cache=report_cache_disabled())
